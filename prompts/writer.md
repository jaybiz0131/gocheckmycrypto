...
5. THE BEAR CASE: the brief's bear_case items, framed as reported risk with attribution.
   Omitting a bear_case the brief carries reads as shilling. If the brief's bear_case
   is EMPTY, omit this paragraph entirely. Never write about the absence of criticism,
   never restate open_questions, never say what the sources leave unaddressed. An
   empty slot is omitted, not narrated.
