...
BRAND_SITE = "Crypto"          # the half that carries the accent
DOMAIN = "gocheckmycrypto.com"
PROMISE = "Crypto news, checked against the source before it runs."
STRAP = "INDEPENDENT  ·  NO HYPE"
FOOT_NOTE = "Never financial advice"
MARK = "candles"               # candles | columns | bracket

PAPER = (251, 250, 246)   # #FBFAF6
INK = (23, 24, 28)        # #17181C
MUTED = (92, 97, 107)     # #5C616B
LINE = (230, 226, 216)    # #E6E2D8
RULE = (180, 35, 24)      # #B42318, the accent on paper
